...
#_(extend-protocol RequestMapDecoder
    HttpServletRequest
    (build-request-map [request]
      (servlet/build-request-map request)))

#_(defn normalize-response
...
#_(defn ^:internal proxy-async-handler
...
#_(defn- https-connector [server http-configuration ssl-context-factory h2? port host max-idle-time]
...
#_(defn- http-connector [server http-configuration h2c? port host max-idle-time proxy?]
